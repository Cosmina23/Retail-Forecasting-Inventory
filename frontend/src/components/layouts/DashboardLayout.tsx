...
import { LayoutDashboard, Package, TrendingUp, History, ChevronLeft, Settings, Bell, FileText, MessageCircle, Store, DollarSign } from "lucide-react";
...
const navItems = [
  ...
  { icon: Store, label: "Store Planogram", path: "/planogram" },
